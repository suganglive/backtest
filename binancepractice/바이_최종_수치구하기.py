...
logging.basicConfig(filename='bi_timeadj.log', level=logging.INFO, format='%(message)s')
...
for hour in hours:
    df = pd.read_excel(f'/Users/sugang/Documents/GitHub/backtest/binancedata/bi_{hour}_timeadj.xlsx')
