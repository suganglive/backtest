...
ss = {'btc': get_daily_ohlcv_from_base("KRW-BTC", base = '3h'), 'eth': get_daily_ohlcv_from_base("KRW-ETH", base = '3h'),
      'xrp': get_daily_ohlcv_from_base("KRW-XRP", base = '3h'), 'ltc': get_daily_ohlcv_from_base("KRW-LTC", base = '3h')}
